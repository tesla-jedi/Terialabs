...
#define enable 11 /// puerto de activación sensor UV [1=enable]
...
///>>>medidor de bateria
float carga=0;
int pinpow=15;   ///Voltaje sensor pin
///>>>sht30
...
double ReadVoltage(int ADC_Pin, int offset){
  ...
  return analogReadMilliVolts((ADC_Pin)/1000)*offset;
...
//////////////////////////////////////////////////////////////////////
  ...
  */  
  ...
  /*
  sprintf(query,INSERT_SQL,tim,t,h,300,0,0,0,0);  ///// cadena para SQL
  Serial.println(query);
  Serial.print("Connecting to SQL...  ");
  
  IPAddress server_addr(162,241,62,55);  // IP of the MySQL *server* here

  if (conn.connect(server_addr, 3306, "terialab_killerpollo",  "espectra2017")){
